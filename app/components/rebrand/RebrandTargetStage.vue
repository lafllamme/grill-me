...
<template>
  <section id="target" class="mx-auto px-4 pb-24 pt-8 max-w-[88rem] scroll-mt-28 lg:px-10 sm:px-6 lg:pb-36 lg:pt-12">
            ...
            <div class="flex gap-1.5 min-w-0 items-center sm:gap-2">
              ...
              <div ref="selectorRef" class="relative">
                ...
                >
                  <div
                    v-if="isSelectorOpen"
                    class="p-2 border-[1px] border-explore-border rounded-2xl border-solid bg-explore-ink/96 min-w-[19rem] shadow-[inset_0_1px_8px_rgba(255,255,255,0.05),0_28px_90px_rgba(0,0,0,0.72)] bottom-[calc(100%+0.75rem)] left-0 absolute z-30 backdrop-blur-2xl"
                    role="listbox"
