...
const enterProgress = useBklitEnter(context.animate, campaignBaseDelay + props.index * campaignStagger, `${context.motionReplayKey}-${props.index}`, context.enterTransition)
