...
export function useBklitEnter(shouldAnimate: boolean, delaySeconds: number, replayKey: MaybeRefOrGetter<string> = '', options: { type?: 'spring' | 'tween', durationSeconds?: number, stiffness?: number, damping?: number, mass?: number } = {}) {
