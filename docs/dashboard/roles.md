...
| Positive | [Ungrillable](../profiles/ungrillable.md) | ≥75 | ≥75 | ≥75 | ≥75 | ≥75 |
...
Ungrillable is checked first as the all-strong pattern. All other matching
roles are collected as candidates; the strongest supported signal becomes the
primary role and other matches remain secondary signals. No else-if ordering
may hide a valid candidate.
